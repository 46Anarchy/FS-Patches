...
public class WorldGuardBridgeSTFUPleaseDontCrashShit  extends BasePatch {
    public static final String TARGET = "fr.paladium.worldguardbridge.server.ServerProxy";
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        for (MethodNode method : node.methods) {
            if (method.name.equals("isLoaded")) {
